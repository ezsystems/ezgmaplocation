{* Weblog - Full view *}
{* 
This includes a tiny picture of the location in a weblog post. To use, add a 
'location' attribute to the weblog class.
*}
...
{/literal}          
          map.setCenter(new GLatLng({$node.object.data_map.location.content.latitude},{$node.object.data_map.location.content.longitude}), 0);
{literal}
          map.setZoom(17);
...
<div id="map" style="width:100px;height:100px;float:right"></div>        
