...
class ezgmlLocationFilter
{
    ...
    function createSqlParts( $params )
    {
         ...
         * {def $users_close_by = fetch( 'content', 'tree', hash(
                                      ...
                                      'extended_attribute_filter', hash( 'id', 'ezgmlLocationFilter', 'params', array( 59.917, 10.729 ) )
                                      ) )}
         * 
         */


        $latitude = isset( $params[0] ) && is_numeric( $params[0] ) ? $params[0] : 59.917;
        $longitude = isset( $params[1] ) && is_numeric( $params[1] ) ? $params[1] : 10.729;
        $distance = isset( $params[2] ) && is_numeric( $params[2] ) ? $params[2] : 0.5;
        ...
        $sqlJoins = "ezgmaplocation.latitude > $minLatitude AND ezgmaplocation.latitude < $maxLatitude AND
        ...
        return array('tables' => ', ezcontentobject_attribute, ezgmaplocation', 'joins' => $sqlJoins, 'columns' => '');
    }
}
?>